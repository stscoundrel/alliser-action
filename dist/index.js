...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.filterByExtensions = void 0;
const getExtension = (filename) => `.${filename.split('.').pop()}`;
const filterByExtensions = (files, extensions, ignores) => (files
...
exports["default"] = {
    filterByExtensions: exports.filterByExtensions,
};
...
exports["default"] = {
    ...
    listFilesinFolders: exports.listFilesinFolders,
};
//# sourceMappingURL=index.js.map
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validate = exports.check = void 0;
const finder_1 = __importDefault(__nccwpck_require__(948));
const extensions_1 = __nccwpck_require__(169);
...
exports.check = check;
const validate = (extensions, folders) => {
    const incorrects = (0, exports.check)(extensions, folders);
...
const alliser_1 = __importDefault(__nccwpck_require__(452));
const parseCommaSeparated = (input) => input.split(',');
try {
    const extensions = parseCommaSeparated(core_1.default.getInput('extensions'));
    const folders = parseCommaSeparated(core_1.default.getInput('folders'));
